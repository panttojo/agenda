...
class User(AbstractBaseUser, UUIDModel, PermissionsMixin):
    ...
    username = CICharField(_("username"), max_length=120, unique=True, db_index=True)
    # https://docs.djangoproject.com/en/3.2/ref/contrib/postgres/fields/#citext-fields
    email = CIEmailField(_("email address"), blank=True)
